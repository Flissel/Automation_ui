...
if [ "$SKIP_DESKTOP_CLIENT" = false ]; then
    DESKTOP_CLIENT_PATH="$SCRIPT_DIR/desktop-client"
...
WS_SERVER_PATH="$SCRIPT_DIR/local-websocket-server.js"
...
if [ "$SKIP_DESKTOP_CLIENT" = false ]; then
    ...
    SPAWNER_PATH="$SCRIPT_DIR/desktop-client/desktop_spawner.py"
