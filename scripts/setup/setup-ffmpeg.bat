@echo off
REM Ensure working directory is the project root when running from scripts/setup
pushd "%~dp0..\.."
REM 🎬 FFmpeg Setup für TRAE Unity AI Platform...
...
REM Erstelle Wrapper-Batch-Datei im Projektstamm
...
REM Return to original directory before exiting
popd
pause