...
from ..models.workflow import WorkflowExecution, NodeExecutionResult, ExecutionStatus
...
class WebSocketConnection:
    ...
    def unsubscribe_from_execution(self, execution_id: str):
        ...
        logger.debug(f"Client {self.client_id} unsubscribed from execution {execution_id}")
...
class WebSocketManager:
    ...
    async def broadcast_node_result(self, execution_id: str, node_result: NodeExecutionResult):
    ...
    async def broadcast_execution_log(self, execution_id: str, log_message: str, level: str = "info"):
    ...
    async def broadcast_variable_update(self, execution_id: str, variable_name: str, variable_value: Any):
    ...
    async def _broadcast_to_execution_subscribers(self, execution_id: str, message: Dict[str, Any]):
