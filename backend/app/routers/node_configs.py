...
@log_api_request(logger)
async def create_node_config(node_type: str, config_data: NodeConfigCreate, request: Request):
...
@log_api_request(logger)
async def update_node_config(node_type: str, config_id: str, update_data: NodeConfigUpdate, request: Request):
...
@log_api_request(logger)
async def validate_node_config(node_type: str, config_data: Dict[str, Any], request: Request):
