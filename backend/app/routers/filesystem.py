    ...
    try:
        ...
        if file_watcher_service:
            ...
            if hasattr(file_watcher_service, 'get_active_watchers_count'):
                status_info["active_watchers"] = file_watcher_service.get_active_watchers_count()
            elif hasattr(file_watcher_service, 'watchers') and hasattr(file_watcher_service.watchers, '__len__'):
