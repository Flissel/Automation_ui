...
class TestAutoApprove(unittest.TestCase):
    ...
    def test_auto_approve_after_threshold(self):
        ...
        result1 = self.registry.suggest_category(
            name="game_icon", description="Gaming icon", parent="icon"
        )
        ...
        result2 = self.registry.suggest_category(
            name="game_icon", description="Gaming application icon", parent="icon"
        )
        ...
        result3 = self.registry.suggest_category(
            name="game_icon", description="Gaming app icon", parent="icon"
        )
    ...
    def test_manual_approve(self):
        ...
        # Vorschlagen
        self.registry.suggest_category(name="test_icon", description="Test icon")
    ...
    def test_reject_pending(self):
        ...
        self.registry.suggest_category(
            name="bad_category", description="Should be rejected"
        )
...
class TestRegistryPersistence(unittest.TestCase):
    ...
    def test_save_and_reload(self):
        ...
        registry1.add_category(
            name="test_cat", description="Test category", examples=["Example1"]
        )
            ...
            "pendingCategories": [
                {
                    ...
                    "votes": 2,
                    "suggestedBy": "llm",
                    "firstSuggested": datetime.now().isoformat(),
                    "lastSuggested": datetime.now().isoformat(),
                }
            ],
            "settings": {
                "autoApproveThreshold": 3,
